...
Forest) y una red neuronal convolucional (CNN). Sobre 2976 imágenes (2890 del
dataset público y 86 propias), la SVM logró la mejor F1-macro de prueba (0{,}960),
seguida de Random Forest (0{,}951) y la CNN (0{,}944), superando claramente a la
línea base logística (0{,}841). Se sigue
...
añadieron \textbf{86 fotografías propias} tomadas para este proyecto (48 sanas y
38 intermedias), como exige el caso de estudio, integradas a las clases buena y
regular. En total, \textbf{2976 imágenes} (buena 1197, regular 638, mala 1141).
Las Figs.~\ref{fig:dist} muestran la distribución de calidad y tamaño.
...
\textbf{Modelado.} Partición estratificada 70/30 (2083 entrenamiento, 893
...
(0{,}960), seguida por Random Forest (0{,}951) y la CNN (0{,}944); la regresión
logística, como línea base, quedó claramente por debajo (0{,}841). La validación
cruzada fue consistente con la prueba (p.\,ej. SVM: 0{,}964 en CV frente a
0{,}960 en prueba), lo que indica ausencia de sobreajuste severo. Las matrices de
...
\begin{table}[t]
\caption{Resultados globales (prueba, $n=893$).}
\label{tab:res}
\centering
\begin{tabular}{lccc}
\toprule
...
\midrule
Regresión logística & 0.837 & 0.841 & 0.855 \\
\textbf{SVM (RBF)}  & \textbf{0.959} & \textbf{0.960} & \textbf{0.964} \\
Random Forest       & 0.951 & 0.951 & 0.956 \\
CNN (3 conv.)       & 0.944 & 0.944 & --- \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Reg. logística & 0.81 & 0.87 & 0.84 \\
SVM (RBF)      & 0.95 & 0.97 & 0.96 \\
...
mejor opción (F1-macro 0{,}960), por encima de una CNN entrenada desde cero a
...
métricas}. Como trabajo futuro: ampliar y diversificar el dataset (más fotos
